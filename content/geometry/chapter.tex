...
\section{Geometric primitives}
	...
	\kactlimport{LineProjectionReflection.h} % if space is an issue: this can be removed
	\kactlimport{Angle.h}
...
\section{Misc. Point Set Problems}
	...
	% \kactlimport{DelaunayTriangulation.h} % we don't use this because https://github.com/kth-competitive-programming/kactl/commits?author=simonlindholm
